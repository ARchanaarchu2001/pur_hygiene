              ...
              >
                ...
                >
                  ...
                  <div className="mb-8 flex justify-center relative">
                    ...
                    {/* <motion.div
                      className="absolute inset-0 rounded-full bg-gradient-to-r from-[#006E38]/10 to-[#1e75bd]/10"
                      animate={isHovered ? {
                        scale: [1, 1.3, 1],
                        opacity: [0.3, 0.6, 0.3]
                      } : {}}
                    ...
                    {isHovered && (
                      <>
                        {[...Array(6)].map((_, i) => (
                          <motion.div
                            key={i}
                            className="absolute w-2 h-2 bg-gradient-to-r from-[#006E38] to-[#1e75bd] rounded-full"
                            initial={{ 
                              opacity: 0,
                              scale: 0,
                              x: 0,
